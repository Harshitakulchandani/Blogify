<%-- 
    Document   : index
    Created on : 18 Jun 2024, 10:04:12 pm
    Author     : harsh
--%>

<%@page import="newpackageHelper.ConnectionProvider"%>
...
<html>
    ...
    <body>
        <!-- this is showing that connection has been established          
        
        //under scriplet tag   
        Connection con=ConnectionProvider.getConnection();
        
        //under expression tag    
         con
         -->
        ...
        <!--to check java script is working  
